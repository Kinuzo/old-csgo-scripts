...
service:add_notification("Dogao | Load",string.format("Welcome back %s, have a nice game", cheatusername), 4)
local primordial = {
...
local variables = {
    keybind = {
        x = menu.add_slider("Dogao | hidden", "kb_x", 0, 3840),
        y = menu.add_slider("Dogao | hidden", "kb_y", 0, 2160),
        offsetx = 0,
        offsety = 0,
    ...
    spectator = {
        x = menu.add_slider("Dogao | hidden", "spec_x", 0, 3840),
        y = menu.add_slider("Dogao | hidden", "spec_y", 0, 2160),
        offsetx = 0,
        offsety = 0,
        alpha = 0,
        list = {},
...
local lua_menu = {
    --main
    user = menu.add_text("Dogao | Information", string.format("Username: %s", cheatusername)),
    buildstate = menu.add_text("Dogao | Information", string.format("Build: %s", build)),
    selection_item = menu.add_selection("Dogao | Information", "Current Tab:", {"Anti-aims", "Visuals", "Misc"}),

    --antiaims
    selection_presets = menu.add_selection("Dogao | Anti-aims", "Anti-aim preset:", {"Slow jitter", "Hybrid", "Aggressive jitter", "Condition"}),
    selection_condition = menu.add_selection("Dogao | Anti-aims", "Player state:", {"Global","Standing", "Moving", "Slowwalk", "Crouch", "air"}),
    yaw_base = menu.add_selection("Dogao | Anti-aims", "Yaw Base", {"Center", "At target crosshair", "At target distance"}),
    Disabler_jite = menu.add_checkbox("Dogao | Anti-aims", "Disable Jitter On Manual", false),

    Enable_global = menu.add_checkbox("Dogao | Anti-aims Global", "Enable", false),
    Gl_yaw_add = menu.add_slider("Dogao | Anti-aims Global", "Yaw add left", -50, 50),
    Gr_yaw_add = menu.add_slider("Dogao | Anti-aims Global", "Yaw add right", -50, 50),
    Gjitter_offset = menu.add_slider("Dogao | Anti-aims Global", "jitter offset", -90, 90),
    GOn_shot = menu.add_selection("Dogao | Anti-aims Global", "On-shot:", {"Off", "Opposite", "Same Side", "Random"}),
    Gfake_limit_left = menu.add_slider("Dogao | Anti-aims Global", "Fake limit Left", 1, 60),
    Gfake_limit_right = menu.add_slider("Dogao | Anti-aims Global", "Fake limit right", 1, 60),

    Sl_yaw_add = menu.add_slider("Dogao | Anti-aims Standing", "Yaw add left", -50, 50),
    Sr_yaw_add = menu.add_slider("Dogao | Anti-aims Standing", "Yaw add right", -50, 50),
    Saw_base = menu.add_selection("Dogao | Anti-aims Standing", "Yaw Jitter", {"Center", "At target crosshair", "At target distance"}),
    Sjitter_offset = menu.add_slider("Dogao | Anti-aims Standing", "jitter offset", -90, 90),
    SOn_shot = menu.add_selection("Dogao | Anti-aims Standing", "On-shot:", {"Off", "Opposite", "Same Side", "Random"}),
    Sfake_limit_left = menu.add_slider("Dogao | Anti-aims Standing", "Fake limit Left", 1, 60),
    Sfake_limit_right = menu.add_slider("Dogao | Anti-aims Standing", "Fake limit right", 1, 60),
   
    Ml_yaw_add = menu.add_slider("Dogao | Anti-aims Moving", "Yaw add left", -50, 50),
    Mr_yaw_add = menu.add_slider("Dogao | Anti-aims Moving", "Yaw add right", -50, 50),

    Mjitter_offset = menu.add_slider("Dogao | Anti-aims Moving", "jitter offset", -90, 90),
    MOn_shot = menu.add_selection("Dogao | Anti-aims Moving", "On-shot:", {"Off", "Opposite", "Same Side", "Random"}),
    Mfake_limit_left = menu.add_slider("Dogao | Anti-aims Moving", "Fake limit Left", 1, 60),
    Mfake_limit_right = menu.add_slider("Dogao | Anti-aims Moving", "Fake limit right", 1, 60),
   
    SLl_yaw_add = menu.add_slider("Dogao | Anti-aims Slowwalk", "Yaw add left", -50, 50),
    SLr_yaw_add = menu.add_slider("Dogao | Anti-aims Slowwalk", "Yaw add right", -50, 50),

    SLjitter_offset = menu.add_slider("Dogao | Anti-aims Slowwalk", "jitter offset", -90, 90),
    SLOn_shot = menu.add_selection("Dogao | Anti-aims Slowwalk", "On-shot:", {"Off", "Opposite", "Same Side", "Random"}),
    SLfake_limit_left = menu.add_slider("Dogao | Anti-aims Slowwalk", "Fake limit Left", 1, 60),
    SLfake_limit_right = menu.add_slider("Dogao | Anti-aims Slowwalk", "Fake limit right", 1, 60),
   
    Cl_yaw_add = menu.add_slider("Dogao | Anti-aims Crouch", "Yaw add left", -50, 50),
    Cr_yaw_add = menu.add_slider("Dogao | Anti-aims Crouch", "Yaw add right", -50, 50),
 
    Cjitter_offset = menu.add_slider("Dogao | Anti-aims Crouch", "jitter offset", -90, 90),
    COn_shot = menu.add_selection("Dogao | Anti-aims Crouch", "On-shot:", {"Off", "Opposite", "Same Side", "Random"}),
    Cfake_limit_left = menu.add_slider("Dogao | Anti-aims Crouch", "Fake limit Left", 1, 60),
    Cfake_limit_right = menu.add_slider("Dogao | Anti-aims Crouch", "Fake limit right", 1, 60),
       
    Al_yaw_add = menu.add_slider("Dogao | Anti-aims air", "Yaw add left", -50, 50),
    Ar_yaw_add = menu.add_slider("Dogao | Anti-aims air", "Yaw add right", -50, 50),

    Ajitter_offset = menu.add_slider("Dogao | Anti-aims air", "jitter offset", -90, 90),
    AOn_shot = menu.add_selection("Dogao | Anti-aims air", "On-shot:", {"Off", "Opposite", "Same Side", "Random"}),
    Afake_limit_left = menu.add_slider("Dogao | Anti-aims air", "Fake limit Left", 1, 60),
    Afake_limit_right = menu.add_slider("Dogao | Anti-aims air", "Fake limit right", 1, 60),

    --visuals
    Colortxt = menu.add_text("Dogao | Visuals", "Main color"),
    Hitlogsss = menu.add_checkbox("Dogao | Visuals", "HitLogs", false),
    manual_indicator = menu.add_checkbox("Dogao | Visuals", "Manual Indicator", false),
    indicators = menu.add_checkbox("Dogao | Visuals", "Indicators", false),
    selection_indicators = menu.add_selection("Dogao | Visuals", "Indicators:", {"None", "Classic", "Modern", "Standard"}),

    masks = menu.add_selection("Dogao | Mask Changer", "Select", list_names),
    custom_models = menu.add_checkbox("Dogao | Mask Changer", "Enable Custom Models", false),
    custom_modes_path = menu.add_text_input("Dogao | Mask Changer", "Path"),
    --misc
    m_max_compensation_ticks = menu.add_slider( "Dogao | Misc", "max compensation ticks", 0, 12 ),
    multi_selection = menu.add_multi_selection("Dogao | Misc", "animations", {"reversed legs", "Static when slow walk", "static legs in air", "Lean when running"}),
    custom_font_enable = menu.add_checkbox("Dogao | Misc", "Custom ESP font"),
}
...
menu.add_button("Dogao | Information", "Load Default Config", function()
    --anti-aims
    ...
    service:add_notification("Dogao | Config", "Default Config load Succses", 4)
end)
...
local function Visuals_indic()
    ...
    if lua_menu.selection_indicators:get() == 3 then
        local eternal_ts = render.get_text_size(pixel, "DOGAO")
        render.text(pixel, "DOGAO", vec2_t(x - 10, y+ay), color_t(255, 255, 255, 255), true, true)
        render.text(pixel, "ALPHA", vec2_t(x+eternal_ts.x-2 - 9, y+ay),color_t(color_acc:get().r, color_acc:get().g, color_acc:get().b, alpha), false, true)
        ay = ay + 10
    ...
    if lua_menu.selection_indicators:get() == 2 then
        ...
        local text_size      = render.get_text_size(font_inds, "Dogao")
        ...
        render.text(font_inds, "DOGAO", vec2_t(x + 2, y + 43), indi_color, true)
    ...
    if lua_menu.selection_indicators:get() == 4 then
        ...
        local eternal_ts = render.get_text_size(pixel, "DOGAO")
        render.text(font_inds, "DOGAO", vec2_t(x + 0, y+ 33), indi_color, true, true)
...
local function draw_menu()
    if not show then
      --  text_input_item:set_visible(false)
        menu.set_group_visibility("Dogao | Information", true)
        ...
        antia = false
        menu.set_group_column("Dogao | Information", 1)
        ...
        if menu_val == 1 then
            ...
            if selection_presets == 4 then
                ...
                if menu_conditiom == 1 then
                    --Dogao | hidden
                    menu.set_group_visibility("Dogao | Anti-aims Global", true)
                    menu.set_group_visibility("Dogao | Anti-aims Standing", false)
                    menu.set_group_visibility("Dogao | Anti-aims Moving", false)
                    menu.set_group_visibility("Dogao | Anti-aims Slowwak", false)
                    menu.set_group_visibility("Dogao | Anti-aims Slowwalk", false)
                    menu.set_group_visibility("Dogao | Anti-aims Crouch", false)
                    menu.set_group_visibility("Dogao | Anti-aims air", false)

               
                elseif  menu_conditiom == 2 then
                    menu.set_group_visibility("Dogao | Anti-aims Global", false)
                    menu.set_group_visibility("Dogao | Anti-aims Standing", true)
                    menu.set_group_visibility("Dogao | Anti-aims Moving", false)
                    menu.set_group_visibility("Dogao | Anti-aims Slowwak", false)
                    menu.set_group_visibility("Dogao | Anti-aims Crouch", false)
                    menu.set_group_visibility("Dogao | Anti-aims air", false)
                ...
                elseif  menu_conditiom == 3 then
                    menu.set_group_visibility("Dogao | Anti-aims Global", false)
                    menu.set_group_visibility("Dogao | Anti-aims Standing", false)
                    menu.set_group_visibility("Dogao | Anti-aims Moving", true)
                    menu.set_group_visibility("Dogao | Anti-aims Global", false)
                    menu.set_group_visibility("Dogao | Anti-aims Slowwalk", false)
                    menu.set_group_visibility("Dogao | Anti-aims Crouch", false)
                    menu.set_group_visibility("Dogao | Anti-aims air", false)
                ...
                elseif  menu_conditiom == 4 then
                    ...
                    menu.set_group_visibility("Dogao | Anti-aims Standing", false)
                    menu.set_group_visibility("Dogao | Anti-aims Moving", false)
                    menu.set_group_visibility("Dogao | Anti-aims Slowwalk", true)
                    menu.set_group_visibility("Dogao | Anti-aims Crouch", false)
                    menu.set_group_visibility("Dogao | Anti-aims air", false)
                ...
                elseif  menu_conditiom == 5 then
                    ...
                    menu.set_group_visibility("Dogao | Anti-aims Moving", false)
                    menu.set_group_visibility("Dogao | Anti-aims Slowwalk", false)
                    menu.set_group_visibility("Dogao | Anti-aims Crouch", true)
                    menu.set_group_visibility("Dogao | Anti-aims air", false)
                ...
                elseif  menu_conditiom == 6 then
                    ...
                    menu.set_group_visibility("Dogao | Anti-aims Slowwalk", false)
                    menu.set_group_visibility("Dogao | Anti-aims Crouch", false)
                    menu.set_group_visibility("Dogao | Anti-aims air", true)
            ...
            menu.set_group_visibility("Dogao | Mask Changer", false)
          menu.set_group_visibility("Dogao | Visuals", false)
          menu.set_group_visibility("Dogao | Misc", false)
          menu.set_group_visibility("Dogao | Anti-aims", true)
          menu.set_group_column("Dogao | Anti-aims", 2)
        ...
        elseif menu_val == 2 then
            ...
            menu.set_group_visibility("Dogao | Anti-aims", false)
            menu.set_group_visibility("Dogao | Visuals", true)
            menu.set_group_visibility("Dogao | Mask Changer", true)
            menu.set_group_visibility("Dogao | Misc", false)
            menu.set_group_column("Dogao | Visuals", 2)
        ...
        elseif menu_val == 3 then
            ...
            menu.set_group_visibility("Dogao | Anti-aims", false)
            menu.set_group_visibility("Dogao | Visuals", false)
            menu.set_group_visibility("Dogao | Misc", true)
            menu.set_group_column("Dogao | Misc", 2)
        end
        menu.set_group_visibility("Dogao | hidden", false)
        menu.set_group_column("Dogao | hidden", 3)
    else
    --  checkbox:set_visible(false)
    --  text_eu:set_visible(false)
      menu.set_group_visibility("Dogao | hidden", false)
      menu.set_group_visibility("Dogao | Information", false)
      menu.set_group_visibility("Dogao | Anti-aims Standing", false)
      menu.set_group_visibility("Dogao | Anti-aims Moving", false)
      menu.set_group_visibility("Dogao | Anti-aims Global", false)
      menu.set_group_visibility("Dogao | Anti-aims Slowwalk", false)
